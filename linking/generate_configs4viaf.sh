...
java -jar "$GENCONFIG_JAR" limes "$LINKED_TMP_DATA_FOLDER/swissbib_blocks" "$LINKED_TMP_DATA_FOLDER/viaf_blocks" \
            "$ROOT_DIRECTORY/linking/templates/swissbib-viaf_birthYear.xml.template" "$ROOT_DIRECTORY/linking/configs"
...
#java -jar $root_dir/genconfig-tool/genconfig-1.0-SNAPSHOT.jar limes $root_dir/data/swissbib/swissbib_blocks $root_dir/data/viaf/viaf_blocks $root_dir/linking/templates/swissbib-viaf_birthYear_gndidentifier.xml.template $root_dir/linking/configs
